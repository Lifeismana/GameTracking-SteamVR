    ...
    t = {
      ...
      7373: (e, t, o) => {
        ...
        let ae = (z = class extends l.Component {
          ...
          onDockOverlay(e, t, o) {
            ...
            (t != S.RA.LeftHand && t != S.RA.RightHand && t != S.RA.Theater) ||
              Y.B.m_mapOverlayState.forEach((o, r) => {
                o.dockLocation == t &&
          ...
          renderActiveOverlay() {
            ...
            if (!o) return null;
            const r = Y.B.m_mapOverlayState.get(e),
              n = r ? r.fScale : 1,
          ...
          show(e) {
            ...
            let r = { type: z.k_sRequestDashboardTabsMessage };
            this.m_mailbox.SendMessage("vrcompositor_systemlayer", r),
              (0, i.qI)();
          }
          hide(e) {
          ...
          renderVRGamepadUISidePanels() {
            ...
            let r = z.k_nControlBarWidthMeters / 2;
            o == W.Near ||
              (o == W.Middle
                ? (r *= 1.5)
                : o == W.Far
          ...
          renderDashboard() {
            ...
            if (k) {
              ...
              C = !!e && VRHTML.VROverlay.GetFlag(e, i.Z9.EnableControlBar);
            }
            let w = 2,
              M = 2.5;
        ...
        function le(e, t) {
          let o = -1,
            r = -1;
          for (let n = 0; n < se.length && o < 0 && r < 0; n++)
            se[n](e) && (o = n), se[n](t) && (r = n);
          return (
            o < 0 && (o = se.length),
            r < 0 && (r = se.length),
