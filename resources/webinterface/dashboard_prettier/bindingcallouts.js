    ...
    t = {
        ...
        class v extends d.Mo {
          ...
          buildNode(e, t) {
            ...
            return (
              ...
              (c.properties["subview-parent-panel-id"] = (0, p.Hb)(
      ...
      5867: (e, t, o) => {
        ...
        let l = 0,
          d = 0,
          c = -1;
        var u, p, h, m, v, _, g, y, b, f, S, k, R, C, w, D, M;
        !(function (e) {
          (e[(e.None = 0)] = "None"),
            (e[(e.Shown = 1)] = "Shown"),
            (e[(e.Hidden = 2)] = "Hidden"),
      ...
      9626: (e, t, o) => {
        ...
        class h {
          ...
          LoadSessionDevData() {
            ...
            return (0, r.mG)(this, void 0, void 0, function* () {
              const r = JSON.parse(
                null !==
                  (e = sessionStorage.getItem(h.k_strSessionStorageKey)) &&
                  void 0 !== e
                  ? e
                  : "{}",
              );
        ...
        (h.k_strSessionStorageKey = "DashboardStoreSessionStorage"),
          (0, r.gn)([a.LO], h.prototype, "m_bShowLegacyBar", void 0),
          (0, r.gn)([a.LO], h.prototype, "m_bDarkMode", void 0),
          (0, r.gn)([a.LO], h.prototype, "m_eTheaterStereo", void 0),
          (0, r.gn)([a.LO], h.prototype, "m_eIncognitoMode", void 0),
          (0, r.gn)([a.LO], h.prototype, "m_mapOverlayState", void 0),
          (0, r.gn)(
            [a.LO],
            h.prototype,
          ...
          (0, r.gn)([i.ak], h.prototype, "LoadSessionDevData", null),
          (0, r.gn)([i.ak], h.prototype, "SaveSessionDevData", null),
          (0, r.gn)([a.Fl], h.prototype, "eTheaterScreen", null),
          (0, r.gn)([a.Fl], h.prototype, "isVRGamepadUI", null),
          (0, r.gn)([a.Fl], h.prototype, "isVRGamepadUIViaGamescope", null),
          (0, r.gn)([i.ak], h.prototype, "updateBodyClasses", null);
        const m = new h();
      ...
      7373: (e, t, o) => {
        ...
        class I extends l.Component {
          ...
          render() {
            ...
            const p = ((e) => {
              ...
              _ = p.replace(/header\.jpg$/, "library_hero.jpg");
            return l.createElement(
              k.lL,
              {
              ...
              l.createElement(
                ...
                l.createElement(M, { appkey: t, title: o, imageUrl: p }),
              ),
              l.createElement(
                "div",
        ...
        (0, n.gn)([a.ak], I.prototype, "onExitApp", null),
          (0, n.gn)([a.ak], I.prototype, "onReturnToGame", null),
          (0, n.gn)(
            [a.ak],
            I.prototype,
            "onOpenAppControllerBindingSettings",
          ...
          (0, n.gn)([a.ak], I.prototype, "onOpenAppVideoSettings", null);
        var E,
          V = o(9669),
          x = o.n(V),
          O = o(7475);
        ...
        let de = (te = class extends l.Component {
          ...
          updateVRGamepadUIPathProperties() {
            ...
            for (const e in this.m_mapExternalOverlays) {
              ...
              r.set_icon(c),
                ...
                h.A4 == t.summon_overlay_key && s.set_vr_settings_tab_id(o),
                t.summon_overlay_key == h.T2 && s.set_vr_steam_tab_id(o);
            }
          ...
          onUpdateDashboardTabs(e) {
            ...
            const o = y.G3.settings.get(h.y3);
          ...
          onUpdateWindowList(e) {
            ...
            e.windows.forEach((e) => {
              ...
              this.setState({
                mapWindows: o,
                bWindowViewEnabled:
                  null === (t = y.G3.settings.get(h.fj)) || void 0 === t || t,
              });
          }
          onUpdateDebugInfo(e) {}
          ...
          onDockOverlay(e, t, o) {
            ...
            (t != S.RA.LeftHand && t != S.RA.RightHand && t != S.RA.Theater) ||
              j.B.m_mapOverlayState.forEach((o, r) => {
                o.dockLocation == t &&
                  (this.setDockLocation(e, o, S.RA.Dashboard), (i = !0));
              });
          ...
          getCollisionBoundsFadeVisualizationElements() {
            ...
            let o = [];
            const r =
              null !== (e = y.G3.settings.get(h.yQ)) && void 0 !== e ? e : 0.7;
            for (let e of t) {
          ...
          render() {
            ...
            if (!o && j.B.isDarkMode) {
              ...
              (g.H.Instance.SceneAppIsHome && t) || e || !o
                ? (0, i.OK)({
                    color_mult: 1,
                    reflection_mult: 1,
                    roomview_mult: [1, 1, 1],
          ...
          BShouldShowDashboardAction(e) {
            var t, o, r, n, i, a;
            const s =
                null !== (t = y.G3.settings.get(h.Av)) && void 0 !== t && t,
              l =
                null !== (o = y.G3.settings.get(h.k_)) && void 0 !== o ? o : 0,
          ...
          renderLegacyControlBar(e, t, o) {
            ...
            const d = j.B.isVRGamepadUI,
              ...
              D = (VRHTML.BIsLinkServer(), g.H.Instance.SceneApplicationState),
              M = g.H.Instance.SceneAppIsHome,
              T =
                null ===
                  (s = y.G3.settings.get(
            ...
            const n =
              ...
              a =
                null !==
                  ...
                  ? r
                  : 1,
              s = y.G3.settings.get(h.YL) || j.B.m_bShowLegacyBar;
            return l.createElement(
              l.Fragment,
              null,
              s &&
            ...
            const _ = this.getActiveOverlayKey(),
              g =
                null === (e = ae.U.GetOverlayInfo(_)) || void 0 === e
                  ...
                  : e.sHandle;
            if (g) {
              (c = VRHTML.VROverlay.GetFlag(g, i.Z9.EnableControlBarKeyboard)),
                (p = VRHTML.VROverlay.GetFlag(g, i.Z9.EnableControlBarClose));
              const e = !1;
              v = VRHTML.VROverlay.GetFlag(g, i.Z9.EnableSteamUIButtons) && !e;
            }
            const b =
                null !==
                  (t = y.G3.settings.get(
          ...
          renderDashboard() {
            ...
            let p = [],
              v = [],
              _ =
                null !== (e = y.G3.settings.get(h.FM)) && void 0 !== e ? e : 2;
            if (a.length > _) {
              const e = y.G3.settings.get(h.nf);
              (p = [
            ...
            const w =
                null === (o = ae.U.GetOverlayInfo(C)) || void 0 === o
                  ? void 0
                  : o.sHandle,
              D = !!w && VRHTML.VROverlay.GetFlag(w, i.Z9.EnableControlBar);
            let M = 2,
              T = 2.5;
            const I = y.G3.settings.get("/settings/dashboard/theaterPosition");
            I == oe.Near
              ? ((M *= 0.5), (T *= 0.5))
              : I == oe.Middle
                ? ((M *= 1), (T *= 1))
                          ...
                          l.createElement(
                                  ...
                                  l.createElement(
                                    ...
                                    l.createElement(
                                      c.z,
                                      {
                                        ...
                                        onClick: () => {
                                          this.onDockOverlay(C, S.RA.Dashboard);
                                        },
                                      },
                                      (0, m.Xx)("#DockHere"),
                                    ),
                            ...
                            l.createElement(
                              ...
                              l.createElement(
                                ...
                                this.renderLegacyControlBar(p, v, u),
                                l.createElement(
                                  i.wx,
      ...
      8178: (e, t, o) => {
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    n.s_,
                    {
                      height: 0.1 * g.g.k_nControlBarWidthMeters * t,
                      interactive: !0,
                      requires_laser: !0,
          ...
          render() {
            ...
            if (this.props.dockLocation == f.Theater) {
              ...
              (l = p.B.isDarkMode && t),
                ...
                p.B.eTheaterScreen == S.Curved && (i = w);
            }
            const _ = VRHTML.VROverlay.FindOverlay(this.props.sOverlayKey),
              g =
                _ && VRHTML.VROverlay.GetFlag(_, n.Z9.EnableControlBarKeyboard),
              R =
                (null === VRHTML || void 0 === VRHTML
                  ? void 0
                ...
                s.createElement(
                  ...
                  s.createElement(
                    ...
                    s.createElement(
                      ...
                      s.createElement(n.wx, { id: w, translation: { z: _ } }),
                      s.createElement(
                        n.wx,
                        { translation: { y: -1 * E } },
                        s.createElement(
                          n.s_,
                          {
                            ...
                            height: I,
                            width:
                              p.B.m_eTheaterStereo != n.Ko.Mono ? T : void 0,
                            interactive: !0,
                            ...
                            stereoscopy: p.B.m_eTheaterStereo,
                          },
        ...
        (I.sfMaxDockDist = 0.4),
          ...
          (I.flGrabTransformLerpSpeed = 0.15),
          (0, r.gn)([i.ZP], I.prototype, "onOverlayScaleChanged", null),
          (0, r.gn)([i.ZP], I.prototype, "computeDestination", null),
          (0, r.gn)([i.ZP], I.prototype, "startMove", null),
          (0, r.gn)([i.ZP], I.prototype, "endMove", null),
          (I = b = (0, r.gn)([a.Pi], I));
      },
      1464: (e, t, o) => {
        "use strict";
          ...
          const { popupRequest: A, reparent: H } = e,
            ...
            K = {
              ...
              y:
                null !==
                  (O =
                    null === (x = A.rotation) || void 0 === x
                      ? void 0
                      : x.yaw_degrees) && void 0 !== O
                  ? O
                  : 0,
            },
            q = null === (P = A.inherit_parent_pitch) || void 0 === P || P,
            ...
            return c.createElement(
              ...
              c.createElement(
                a.s_,
                {
                  ...
                  interactive: !1,
                  scrollable: !1,
                  target_dpi_panel_id: n ? void 0 : g.WR,
      ...
      9347: (e, t, o) => {
        ...
        var r,
          ...
          v = o(1628),
          _ = o(6459);
        let g = (r = class extends u.Component {
          constructor(e) {
            super(e),
      ...
      6063: (e, t, o) => {
        ...
        (p.contextType = c.E),
          (0, r.gn)([i.ZP], p.prototype, "startMove", null),
          (0, r.gn)([i.ZP], p.prototype, "endMove", null),
          (p = (0, r.gn)([s.Pi], p));
      },
      421: (e, t, o) => {
        "use strict";
...
//# sourceMappingURL=bindingcallouts.js.map?v=bb4c00724b6b099e5a30
