  ...
  [554],
  {
    582: (e, t, r) => {
          ...
          return (
            c.sm_m ||
              (c.sm_m = {
                proto: c,
                fields: {
                  product: { n: 1, br: o.qM.readString, bw: o.gp.writeString },
                  version: { n: 2, br: o.qM.readString, bw: o.gp.writeString },
      ...
      class l extends a {
        ...
        constructor(e = null) {
          super(),
            l.prototype.identifier || o.Sg(l.M()),
            ...
            l.sm_m ||
              (l.sm_m = {
                ...
                fields: {
                  ...
                  context: { n: 4, br: o.qM.readString, bw: o.gp.writeString },
                },
              }),
            l.sm_m
          );
      ...
      }
      {
        ...
        (console.error = (e, ...r) => {
          const n = w();
          g(new Error(y(e, ...r)), 1, n), t.apply(console, [e, ...r]);
        }),
          (console.clogerror = (e, r, ...n) => {
            const i = w();
            g(new Error(y(r, ...n)), e + 1, i), t.apply(console, [r, ...n]);
          }),
          m("error", (e) => {
            g(e.error, 0);
          }),
      ...
      class R {
        constructor(e = !0) {
          (this.m_transport = null),
            ...
            (this.m_fnGetReportingInterval = O),
            (this.m_bEnabled = !0),
          ...
          return (0, n.sH)(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const i = yield (function (e, t) {
                try {
                  return e.stack && e.stack.match(I)
                    ? (function (e, t) {
                        return (0, n.sH)(this, void 0, void 0, function* () {
                          var r, n;
                          const {
                            ...
                            o =
                              null !==
                                ...
                                ? n
                                : [];
                          let a = B(o.filter((e) => !!e.match(I))[i]);
                          s && (a = `${a} ${e.message}`);
                          const c = o
                            .map((e) => {
                              const t = e.match(/(.*)\((.*):(\d+):(\d+)\)/);
                            ...
                            const {
                              ...
                              o =
                                null !==
                                  ...
                                  ? n
                                  : [];
                            let a = B(o.filter((e) => !!e.match(v))[i]);
                            s && (a = `${a} ${e.message}`);
                            const c = o
                              .map((e) => {
                                const t = e.match(/(.*@)?(.*):(\d+):(\d+)/);
      ...
      const M = () => (C || k(new R()), C),
        k = (e) => {
          (C = e), d.tH.InstallErrorReportingStore(C);
        };
      function N(e) {
        return (0, n.sH)(this, void 0, void 0, function* () {
          try {
            return (yield u(e)).slice(0, 16);
          } catch (e) {
            return "";
          }
        });
      ...
      let j;
      const F = () => (j || (j = new z("https://api.steampowered.com/")), j);
    },
  },
