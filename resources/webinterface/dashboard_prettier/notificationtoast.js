  ...
  var e,
    t = {
      ...
      4790: (e, t, o) => {
        ...
        let C = (r = class extends c.Component {
          constructor(e) {
            super(e),
              (this.state = {
        ...
        (C.sfMaxDockDist = 0.4),
          (C.sfMovePulseMS = 100),
          (C.sfOverlayTrayHeight = 0.12),
          (C.flGrabTransformLerpSpeed = 0.125),
...
//# sourceMappingURL=notificationtoast.js.map?v=2f7e80c235725542991c
