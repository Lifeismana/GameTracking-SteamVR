  ...
  var e,
    t = {
          ...
          updateVRGamepadUIPathProperties() {
            ...
            for (const e in this.m_mapExternalOverlays) {
              ...
              switch (t.summon_overlay_key) {
                case p.T2:
                  r.set_enum(se.mw.k_EVRDashboardTabIcon_Steam);
                  break;
                case p.Xl:
                  r.set_enum(se.mw.k_EVRDashboardTabIcon_DesktopDisplay);
                  break;
                case p.A4:
                  r.set_enum(se.mw.k_EVRDashboardTabIcon_Cog);
                  break;
                case p.PF:
                  if (
                    (r.set_enum(se.mw.k_EVRDashboardTabIcon_RunningGame),
                ...
                default:
                  r.set_overlay(t.summon_overlay_key),
                    r.set_enum(se.mw.k_EVRDashboardTabIcon_Unknown);
              }
              i.set_icon(r),
                a.add_tabs(i),
                o == t.summon_overlay_key && a.set_selected_tab_id(n),
            ...
            for (const e of r) {
              ...
              const r = new se.I_();
              r.set_enum(se.mw.k_EVRDashboardTabIcon_DesktopWindow),
          ...
          BShouldShowDashboardAction(e) {
            ...
            switch (e) {
              case Y.ToggleRoomView:
                ...
                return e && r > 0 && !(this.state.bLinkStreamActive && o);
              case Y.Recenter:
                return (
                  1 !=
                  (null !==
            ...
            super(e),
              ...
              l.Q.SteamVR.SetImplementation(
                ...
                (e) => {
                  ...
                  const r = { type: "request_spawn_window_view", hwnd: i };
      ...
      9850: (e, t, n) => {
        ...
        let w = (R = class extends o.Component {
          constructor(e) {
            super(e),
...
//# sourceMappingURL=systemui.js.map?v=e0472dd6b965e4da521d
