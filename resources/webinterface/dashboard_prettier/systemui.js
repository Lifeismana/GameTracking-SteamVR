  ...
  var e,
    t = {
      ...
      8261: (e, t, a) => {
          ...
          render() {
            ...
            return l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(w, { appkey: t, title: a, imageUrl: p }),
              ),
              l.createElement(
                "div",
        ...
        (0, o.gn)([r.ak], T.prototype, "onExitApp", null),
          (0, o.gn)([r.ak], T.prototype, "onReturnToGame", null),
          (0, o.gn)(
            [r.ak],
            T.prototype,
            "onOpenAppControllerBindingSettings",
          ...
          (0, o.gn)([r.ak], T.prototype, "onOpenAppVideoSettings", null);
        var E,
          M = a(9669),
          L = a.n(M),
          D = a(7475);
        ...
        (0, o.gn)([r.ZP], x.prototype, "onAnimationFrame", null),
          (0, o.gn)([r.ZP], x.prototype, "onScroll", null),
          (0, o.gn)([r.ZP], x.prototype, "onLeftButtonClick", null),
          (0, o.gn)([r.ZP], x.prototype, "onRightButtonClick", null);
        ...
        (0, o.gn)([r.ZP], O.prototype, "buttonMouseEnter", null),
          (0, o.gn)([r.ZP], O.prototype, "buttonMouseLeave", null),
          (0, o.gn)([r.ZP], O.prototype, "onParentScrollStop", null),
          (O = (0, o.gn)([_.Pi], O));
        const H = () =>
        ...
        let N = (A = class extends l.Component {
          ...
          makeAppButtonList() {
            ...
            return e.map((e, a) => {
              let n = a;
              const o = a < A.TOP_ROW_LENGTH;
              return (
                o || (n -= A.TOP_ROW_LENGTH),
                {
                  key: e.key,
                  appkey: e.key,
                  title: e.name,
          ...
          render() {
            ...
            if (a) e = l.createElement(B, null);
              ...
              e = l.createElement(
                l.Fragment,
                null,
                l.createElement(P, { className: "TopRow", apps: a }),
                l.createElement(P, { className: "BottomRow", apps: n }),
              );
            }
            return l.createElement(
              S.lL,
        ...
        let le = (Z = class extends l.Component {
          ...
          updateVRGamepadUIPathProperties() {
            ...
            const d =
              J.l.BHasMutualCapability(8) && this.BShouldShowDashboardAction(9);
            c.add_actions(
              W.z3.fromObject({
                action_id: 9,
          ...
          initializeOverlayState(e) {
            g.G3.GetAppInfo(e).then((t) => {
              ...
              U.BV.m_mapOverlayState.set(e, {
                ...
                xfInitial: null,
                fScale: o,
                fLastTotalVisibleTimeInSeconds: oe(e),
              }),
          ...
          static getDashboardTranslation() {
            ...
            const a = -Z.getDashboardDistance();
            return {
          ...
          static getDashboardScale() {
            ...
            let t = 1;
            const a = U.BV.currentDashboardPosition;
            return (
              (t =
                a == Y.Near
                  ? 0.36
          ...
          isSceneAppDimmingActive() {
            ...
            return U.BV.m_bDashboardVisible && n && !t && e;
          }
          ...
          setOverlayDockLocation(e, t, a) {
            ...
            U.BV.isTheaterMode,
              (t != b.RA.LeftHand &&
                t != b.RA.RightHand &&
                t != b.RA.Theater) ||
                U.BV.m_mapOverlayState.forEach((a, n) => {
                  a.dockLocation == t && re(e, a, b.RA.Dashboard);
                });
            const i = U.BV.m_mapOverlayState.get(e);
            if (
              (i &&
          ...
          renderActiveOverlay() {
            ...
            if (!t) return null;
            const a = U.BV.m_mapOverlayState.get(e),
              n = a ? a.fScale : 1,
              o = U.BV.isVRGamepadUI
          ...
          switchToOverlayInternal(e, t) {
            ...
            return (
              ...
              (this.m_activeOverlayThatVanished = null),
              U.BV.m_setOverlaysViewedThisSession.add(s.summon_overlay_key),
          ...
          onShowDashboardRequested(e, t) {
            ...
            if (!g.G3.settings.get("/settings/dashboard/enableDashboard"))
              return;
            const n = U.BV.m_mapOverlayState.get(e.overlay_key);
          ...
          hide(e) {
            U.BV.m_bDashboardVisible &&
              ...
              this.setState({ eShowPopoverMenu: Q.None }),
          ...
          render() {
            ...
            const e = this.getActiveOverlaySummonKey(),
              ...
              a = t && t.size > 0,
              n = z.C7.m_eRoomSetupStep != z.wk.Off;
            let o = [];
            return (
            ...
            return (
              (this.isOverlayActive(u.gB) ||
                (null === (e = this.getActiveOverlaySummonKey()) || void 0 === e
                  ? void 0
                  : e.startsWith(u.Vq))) &&
              (this.state.eShowPopoverMenu == Q.None ||
                this.state.eShowPopoverMenu == Q.Windows)
            );
          }
          isVolumeTrayActive() {
            return this.state.eShowPopoverMenu == Q.Volume;
          }
                          ...
                          l.createElement(
                            ...
                            s &&
                              l.createElement(S.NT, {
                                ...
                                label: (0, m.Xx)("#Menu"),
                                style: S.zk.Small,
                                onClick: () => this.showPopoverMenu(Q.Power),
                                onMouseEnter: this.clearPopoverMenuTimeout,
                                onMouseLeave: () =>
                                ...
                                t.length > 0 &&
                                  l.createElement(S.B8, {
                                    ...
                                    active:
                                      ...
                                      Q.ExternalOverlays,
                                    onClick: () =>
                                      this.showPopoverMenu(Q.ExternalOverlays),
                                    onMouseEnter: this.clearPopoverMenuTimeout,
                                    onMouseLeave: () =>
                                      this.startPopoverMenuTimeout(500),
                                  }),
                          ...
                          l.createElement(
                            ...
                            l.createElement(
                              ...
                              l.createElement(S.D6, {
                                active: this.state.eShowPopoverMenu == Q.Volume,
                                refVolumeTray: this.m_refVolumeTray,
                                onShowTray: () =>
                                  this.showPopoverMenu(Q.Volume),
                                onHideTray: () => this.showPopoverMenu(Q.None),
                                onMouseEnter: this.clearPopoverMenuTimeout,
                                onMouseLeave: () =>
                                  this.startPopoverMenuTimeout(500),
                              }),
          ...
          renderLegacyControlBarTrays(e, t) {
            const a = U.BV.isDarkMode ? { r: 0.25, g: 0.25, b: 0.25 } : null;
            return l.createElement(
              l.Fragment,
              null,
              l.createElement(f.e, {
                ...
                tintColor: a,
                onToggleWindowList: () => this.showPopoverMenu(Q.Windows),
          ...
          renderVRGamepadUIBar(e) {
            ...
            const a =
                null !==
                  ...
                  ? t
                  : 0,
              n = U.BV.isVRGamepadUI && !!(1 & a) && U.BV.m_bLinkStreamActive;
            let o = n ? 0.425 : 0.35;
            return l.createElement(
              l.Fragment,
              null,
            ...
            const o =
              ...
              r =
                null !==
                  ...
                  ? n
                  : 1,
              s = g.G3.settings.get(u.YL) || U.BV.m_bShowLegacyBar;
            return l.createElement(
              l.Fragment,
              null,
              s &&
          ...
          renderOverlayControlBar() {
            ...
            const s = this.getActiveOverlayKey(),
              c =
                null === (e = $.U.GetOverlayInfo(s)) || void 0 === e
                  ? void 0
                  : e.sHandle;
            if (!c) return null;
            try {
            ...
            const d =
              ...
              h = { x: 0, y: 0.15, z: 0 },
              p =
                (null === (a = U.BV.m_mapOverlayState.get(s)) || void 0 === a
                  ? void 0
          ...
          renderDashboard() {
            ...
            const v = this.getActiveOverlayDockLocation(),
              ...
              C =
                null === (a = $.U.GetOverlayInfo(f)) || void 0 === a
                  ? void 0
                  : a.sHandle,
                        ...
                        l.createElement(
                          ...
                          l.createElement(
                            ...
                            l.createElement(
                              ...
                              this.state.eShowPopoverMenu == Q.Power &&
                                l.createElement(
                                  i.wx,
                                  {
        ...
        (le.k_sDashboardMailboxName = "systemui_dashboard"),
          ...
          (0, o.gn)([r.ak], le.prototype, "isSceneAppDimmingActive", null),
          (0, o.gn)(
            [r.ak],
            le.prototype,
          ...
          (0, o.gn)([r.ak], le.prototype, "onKeyboardVisibilityChanged", null),
          (0, o.gn)([r.ak], le.prototype, "onGrabStart", null),
          (0, o.gn)([r.ak], le.prototype, "onGrabEnd", null),
          (0, o.gn)(
            [r.ak],
            le.prototype,
          ...
          (0, o.gn)([r.ak], le.prototype, "onDashboardOverlayCreated", null),
          (0, o.gn)([r.ak], le.prototype, "onDashboardOverlayDestroyed", null),
          (0, o.gn)([r.ak], le.prototype, "onUpdateDashboardTabs", null),
          (0, o.gn)([r.ak], le.prototype, "onWindowViewCreated", null),
          (0, o.gn)([r.ak], le.prototype, "onWindowViewDestroyed", null),
          (0, o.gn)([r.ak], le.prototype, "onUpdateWindowList", null),
          (0, o.gn)([r.ak], le.prototype, "onUpdateDebugInfo", null),
          (0, o.gn)([r.ak], le.prototype, "setOverlayDockLocation", null),
          (0, o.gn)([r.ak], le.prototype, "onShowDashboardRequested", null),
          (0, o.gn)([r.ak], le.prototype, "onDockOverlayRequested", null),
          (0, o.gn)([r.ak], le.prototype, "onHideDashboardRequested", null),
          (0, o.gn)([r.ak], le.prototype, "show", null),
          (0, o.gn)([r.ak], le.prototype, "hide", null),
          (0, o.gn)([r.ak], le.prototype, "setPlacementModeActive", null),
          (0, o.gn)([r.ak], le.prototype, "onToggleRoomView", null),
          (0, o.gn)(
            [r.ak],
            le.prototype,
            "onLegacyQuickLaunchButtonClick",
          ...
          (0, o.gn)([r.ak], le.prototype, "onRecenterClick", null),
          (0, o.gn)([r.ak], le.prototype, "onClearRoomSetupClick", null),
          (0, o.gn)([r.ak], le.prototype, "onUserGuideClick", null),
          (0, o.gn)([r.ak], le.prototype, "SetGamepadFocusEnable", null),
          (0, o.gn)([r.ak], le.prototype, "renderLegacyPowerMenu", null),
          (0, o.gn)([r.ak], le.prototype, "startPopoverMenuTimeout", null),
          (0, o.gn)([r.ak], le.prototype, "clearPopoverMenuTimeout", null),
          (0, o.gn)([r.ak], le.prototype, "showPopoverMenu", null),
          (0, o.gn)([r.ak], le.prototype, "popoverMenuMouseLeave", null),
          (0, o.gn)([r.ak], le.prototype, "popoverMenuMouseUp", null),
          (0, o.gn)([r.ak], le.prototype, "hasDashboardOverlay", null),
          (0, o.gn)(
            [r.ak],
            le.prototype,
          ...
          (0, o.gn)([r.ak], le.prototype, "isDesktopTrayActive", null),
          (0, o.gn)([r.ak], le.prototype, "isVolumeTrayActive", null),
          (0, o.gn)([r.ak], le.prototype, "isSteamOverlayActive", null),
          (0, o.gn)([r.ak], le.prototype, "isDesktopOverlayActive", null),
          (0, o.gn)([r.ak], le.prototype, "handleVRLinkInfoClick", null),
          (0, o.gn)([r.ak], le.prototype, "ToggleIncognitoMode", null),
          (0, o.gn)([r.ak], le.prototype, "getRenderModelForShape", null),
          (0, o.gn)([r.ak], le.prototype, "isDesktopViewVisible", null),
          (0, o.gn)([r.ak], le.prototype, "onGameLaunched", null),
          (0, o.gn)([r.ak], le.prototype, "onAddPortal", null),
          (0, o.gn)([r.ak], le.prototype, "onRemovePortal", null),
          (0, o.gn)([r.ak], le.prototype, "onActiveOverlayScaleChange", null),
          (0, o.gn)([r.ak], le.prototype, "onActiveOverlayClosed", null),
          (0, o.gn)([s.LO], le, "s_dashboardUserDistance", void 0),
          (0, o.gn)([s.LO], le, "s_dashboardUserScale", void 0),
          (le = Z = (0, o.gn)([_.Pi], le));
        ...
        function me(e, t) {
          let a = -1,
            n = -1;
          for (let o = 0; o < ue.length && a < 0 && n < 0; o++)
            ue[o](e) && (a = o), ue[o](t) && (n = o);
          return (
            a < 0 && (a = ue.length),
            n < 0 && (n = ue.length),
...
//# sourceMappingURL=systemui.js.map?v=79e38c0d54b55ce3eda2
