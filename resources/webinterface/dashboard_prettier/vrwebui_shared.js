  ...
  [683],
  {
    ...
    4820: (e, t, n) => {
      ...
      class g extends o {
        constructor(e = null) {
          super(),
            g.prototype.dashboard_popup_request_id || s.aR(g.M()),
            o.initialize(this, e, 0, -1, void 0, null);
        }
        static ImplementsStaticInterface() {}
        static M() {
      ...
      class v extends o {
        constructor(e = null) {
          super(),
            v.prototype.pitch_degrees || s.aR(v.M()),
            o.initialize(this, e, 0, -1, void 0, null);
        }
        static ImplementsStaticInterface() {}
        static M() {
      ...
      class b extends o {
        constructor(e = null) {
          super(),
            b.prototype.dashboard_popup_request_id || s.aR(b.M()),
            o.initialize(this, e, 0, -1, void 0, null);
        }
        static ImplementsStaticInterface() {}
        static M() {
    ...
    3081: (e, t, n) => {
      ...
      (B.Name = "dashboard_settings"), (B = (0, i.gn)([l.Pi], B));
      ...
      var Z, $;
      (K.Name = "internal_settings"),
        (0, i.gn)([o.ak], K.prototype, "toggleMirrorRender", null),
        (K = (0, i.gn)([l.Pi], K)),
        (function (e) {
            ...
            this.m_mailbox.Init("WiFiUI").then(() => {
              this.RefreshAccessPoints(),
                  ...
                  let t = () => {
                    if (0 == e.nReturnCode)
                      switch (e.sOutput.charAt(0)) {
                        case "0":
                          this.setState({ softAPState: $.NoSoftAP });
                          break;
                        case "1":
                          this.setState({
                            softAPState: $.Intermediate,
                            sSoftAPMessage: e.sOutput,
                          });
                          break;
                        case "2":
                          this.setState({
                            softAPState: $.Connected,
                      ...
                      this.setState({
                        softAPState: $.ErrorGettingStatus,
                        sSoftAPMessage: e.sOutput,
                      });
                  };
                ...
                S.G3.GetSettingsValue("/settings/internet/enableSoftAP") &&
                  this.setState({ softAPState: $.GettingStatus });
            });
        }
        componentWillUnmount() {
          this.m_mailbox = null;
              ...
              if (n.sError) {
                ...
                window.setTimeout(() => {
                  console.log("Failed to create SAP: " + n.sError),
                    this.setState({
                      softAPState: $.CreationFailure,
                      sSoftAPMessage: n.sError,
                    });
                }, i);
              } else this.setState({ softAPState: $.CreationSuccess });
            } catch (t) {
              let n = Date.now() - e,
                i = Math.max(3e3 - n, 0);
              window.setTimeout(() => {
          ...
          return c.createElement(
            ...
            c.createElement(
              ...
              c.createElement(_.wy, {
                ...
                onChange: (e) => {
                  this.setState({ softAPState: e ? $.Creating : $.Destroying });
                },
                onSubsection: c.createElement(
                  c.Fragment,
                  null,
                  this.state.softAPState == $.Connected &&
                    c.createElement(
                      "span",
                      null,
                      "Hotspot active. ",
                  ...
                  this.state.softAPState == $.GettingStatus &&
                    c.createElement("span", null, "Getting hotspot status..."),
                  this.state.softAPState == $.Intermediate &&
                    c.createElement(
                      "span",
                      null,
                      "Hotspot status: ",
                  ...
                  this.state.softAPState == $.ErrorGettingStatus &&
                    c.createElement(
                      "span",
                      null,
                  ...
                  (this.state.softAPState == $.Creating ||
                    this.state.softAPState == $.CreationSuccess) &&
                    c.createElement("span", null, "Creating hotspot..."),
                  this.state.softAPState == $.CreationFailure &&
                    c.createElement("span", null, this.state.sSoftAPMessage),
                  this.state.softAPState == $.Destroying &&
                    c.createElement("span", null, "Destroying hotspot..."),
                  this.state.softAPState == $.NoSoftAP &&
      ...
      (0, i.gn)([o.ak], J.prototype, "onShowPasswordKeyboard", null),
        (0, i.gn)([o.ak], J.prototype, "BIsPasswordInputEnabled", null);
      ...
      var ie;
      (ne.Name = "playarea_settings"), (ne = (0, i.gn)([l.Pi], ne));
      class se {
        constructor() {
      ...
      (se.driverPrettyNames = {
        ...
        (0, i.gn)([a.LO], se.prototype, "driverList", void 0),
        (0, i.gn)([a.Fl], se.prototype, "visibleDriverList", null),
        (0, i.gn)([a.Fl], se.prototype, "numBlockedDrivers", null),
        (0, i.gn)([a.Fl], se.prototype, "numDisabledDrivers", null),
        (0, i.gn)(
          [a.Fl],
          se.prototype,
      ...
      let ce = (ie = class extends c.Component {
        constructor(e) {
          super(e);
        }
        render() {
          const e = oe.numBlockedDrivers,
            ...
            i = S.G3.routePageSection == ie.PAGE_SECTION;
          return c.createElement(
            c.Fragment,
            null,
            !!n &&
              c.createElement(
                ...
                c.createElement(
                  ...
                  {
                    className: "ButtonControl",
                    onClick: () => S.G3.setRoutePageSection(ie.PAGE_SECTION),
                  },
      ...
      (ce.PAGE_SECTION = "drivermanager"), (ce = ie = (0, i.gn)([l.Pi], ce));
      ...
      (0, i.gn)([o.ZP], de.prototype, "show", null),
        (0, i.gn)([o.ZP], de.prototype, "hide", null),
        (de = (0, i.gn)([l.Pi], de));
      ...
      class he extends c.Component {
        ...
        onClickUpdate() {
          this.setState({ state: pe.InProgress }),
            -1 == this.updateTimer &&
        ...
        onClickCheckForUpdate() {
          console.log("check for update"),
            this.setState({ state: pe.CheckingForUpdate, detail: "" }),
            this.RequestUpdateState();
        }
        onClickReboot() {
      ...
      (0, i.gn)([o.ak], he.prototype, "RequestUpdateState", null),
        (0, i.gn)([o.ak], he.prototype, "onClickUpdate", null),
        (0, i.gn)([o.ak], he.prototype, "onClickCheckForUpdate", null),
        (0, i.gn)([o.ak], he.prototype, "onClickReboot", null),
        (0, i.gn)([o.ak], he.prototype, "onChangeChannel", null);
      class ge extends c.Component {
        ...
        render() {
          ...
          const e = (e) => "/usr/local/steamvr" == me(e.toLowerCase()),
            t = (t) =>
              e(t)
                ? "System Default"
                : ((e) => "/data/work/steamvr" == me(e.toLowerCase()))(t)
                ? "Custom Build"
      ...
      (Se.Name = "system_settings"), (Se = (0, i.gn)([l.Pi], Se));
      var _e,
        ve = n(1464);
      ...
      (0, i.gn)([o.ak], Ce.prototype, "onExitApp", null),
        (0, i.gn)([o.ak], Ce.prototype, "onRestartSteamVR", null),
        (0, i.gn)([o.ak], Ce.prototype, "onRestartRequired", null),
        (0, i.gn)([o.ak], Ce.prototype, "onAppRestartRequired", null);
      let fe = (_e = class extends c.Component {
        constructor(e) {
          super(e),
        ...
        componentDidMount() {
          (this.m_routeObservingAutorunDisposer = (0, a.EH)(() => {
            S.G3.routePage
              ...
              : S.G3.setRoutePage(
                  S.G3.settingsSchema.filter(_e.shouldShowSection)[0].controller
                );
          })),
        ...
        renderSettingsPanelContents() {
          const e = S.G3.settingsSchema.filter(_e.shouldShowSection);
          return c.createElement(
            d.q,
        ...
        renderSectionPage(e) {
          const t = e.controller ? e.controller : "generic",
            ...
            i =
              [C, ue, ne, D.Yw, R, O, B, V, P, K, k.P, Se, Q].find(
                (e) => e.Name === t
              ) || _.d9;
        ...
        static shouldShowSection(e) {
          if (
            ...
            !S.G3.settings.get(_e.k_sShowInternalSettings)
          )
            return !1;
          if (
            e.controller == Se.Name &&
            !S.G3.settings.get(_e.k_sShowSystemSettings)
          )
            return !1;
          if (
            e.controller == Q.Name &&
            !S.G3.settings.get(_e.k_sShowInternetSettings)
          )
            return !1;
          ...
          let t =
            e.controller == B.Name &&
            S.G3.settings.get(_e.k_sShowDashboardSettings);
          return (
      ...
      (fe.k_sShowInternalSettings = "/settings/steamvr/showInternalSettings"),
        (fe.k_sShowSystemSettings = "/settings/steamvr/showSystemSettings"),
        (fe.k_sShowInternetSettings = "/settings/steamvr/showInternetSettings"),
        (fe.k_sShowDashboardSettings =
          "/settings/steamvr/showDashboardSettings"),
        (0, i.gn)([o.ak], fe.prototype, "renderSectionButton", null),
        (0, i.gn)([o.ak], fe.prototype, "renderSectionPage", null),
        (fe = _e = (0, i.gn)([l.Pi], fe));
      const be = (0, l.Pi)(function (e) {
        const t = L.B.GetActiveDashboardPopups().find(
          (e) =>
            e.parent_overlay_key == h.T2 &&
            e.popup_overlay_key.includes("mainmenu")
        );
        return t
          ? c.createElement(ve.a, { popupRequest: t, reparent: !1 })
          : null;
      });
    },
    7095: (e, t, n) => {
      ...
      (E.devices = [
        ...
        (E = _ = (0, i.gn)([r.Pi], E));
      let L = (v = class extends s.Component {
        constructor(e) {
          super(e),
            (this.m_mailbox = new u.Nv()),
            (this.m_routeObservingAutorunDisposer = null),
      ...
      (L.PAGE_SECTION = "appcontrollerbindings"),
        (0, i.gn)([m.Fl], L.prototype, "shouldShowModal", null),
        (0, i.gn)([m.Fl], L.prototype, "currentRouteAppKey", null),
        (0, i.gn)([o.ak], L.prototype, "onApplicationDropdownChange", null),
        (0, i.gn)([o.ak], L.prototype, "onToggleDefaultCustomBinding", null),
        (0, i.gn)([o.ak], L.prototype, "showBindingDetail", null),
        (0, i.gn)([o.ak], L.prototype, "show", null),
        (0, i.gn)([o.ak], L.prototype, "close", null),
        (0, i.gn)([o.ak], L.prototype, "showBindingCallouts", null),
        (0, i.gn)([o.ak], L.prototype, "onToggleDominantHand", null),
        (L = v = (0, i.gn)([r.Pi], L));
      const T = (e) =>
        s.createElement(
          c.GV,
      ...
      (0, i.gn)([o.ak], B.prototype, "OnDiscoverDonglesResponse", null),
        (0, i.gn)([o.ak], B.prototype, "DiscoverDongles", null),
        (0, i.gn)([o.ak], B.prototype, "StartPairing", null),
    ...
    8242: (e, t, n) => {
      ...
      function w(e) {
        ...
        const s = (function (e, t, n) {
            ...
            return (
              r.useEffect(() => (e ? n(e, s).unregister : void 0), [s, e]), i
            );
          })(
            e.detent,
        ...
        makeSettingComponent(e) {
          ...
          switch (e.control) {
            ...
            default:
              ...
              break;
            case "slider":
              t = r.createElement(w, Object.assign({ key: e.name }, e));
          }
          return (
            e.advanced_only &&
              (t = r.createElement(
      ...
      (0, o.gn)([a.ak], M.prototype, "ResetToDefaults", null),
        (0, o.gn)([c.Fl], M.prototype, "schemaComponents", null),
        (M = (0, o.gn)([d.Pi], M));
      ...
      (0, o.gn)([a.ak], R.prototype, "handleChange", null),
        (R = (0, o.gn)([d.Pi], R));
      ...
      (0, o.gn)([a.ak], k.prototype, "onGroupMouseEnter", null),
        (0, o.gn)([a.ak], k.prototype, "onGroupMouseLeave", null),
        (0, o.gn)([a.ak], k.prototype, "onOptionMouseEnter", null),
        (0, o.gn)([a.ak], k.prototype, "onOptionMouseLeave", null),
        (k = (0, o.gn)([d.Pi], k));
      ...
      (0, o.gn)([c.Fl], L.prototype, "value", null),
        (0, o.gn)([a.ak], L.prototype, "onChange", null),
        (L = (0, o.gn)([d.Pi], L));
      ...
      (0, o.gn)([c.Fl], T.prototype, "value", null),
        (0, o.gn)([a.ak], T.prototype, "onChange", null),
        (T = (0, o.gn)([d.Pi], T));
      ...
      (0, o.gn)([a.ak], B.prototype, "onInteractionStart", null),
        (0, o.gn)([a.ak], B.prototype, "onInteractionEnd", null),
        (0, o.gn)([c.Fl], B.prototype, "value", null),
        (0, o.gn)([a.ak], B.prototype, "onChange", null),
        (B = (0, o.gn)([d.Pi], B));
      ...
      (V.WHITE_SIZE_PERCENT = 0.03),
        (0, o.gn)([a.ak], V.prototype, "onSliderChanged", null),
        (V = i = (0, o.gn)([d.Pi], V));
      ...
      (0, o.gn)([c.Fl], P.prototype, "value", null),
        (0, o.gn)([a.ak], P.prototype, "onSliderChanged", null),
        (P = (0, o.gn)([d.Pi], P));
      let D,
        O = class extends r.Component {
          ...
          onAlphaChange(e) {
            ...
            this.props.name && u.G3.SetSettingsValue(this.props.name, I(n)),
              this.props.nameA &&
          ...
          onColorChange(e) {
            ...
            this.props.name && u.G3.SetSettingsValue(this.props.name, I(t)),
      ...
      (0, o.gn)([c.Fl], O.prototype, "value", null),
        (0, o.gn)([c.Fl], O.prototype, "alphaScale", null),
        (0, o.gn)([a.ak], O.prototype, "onAlphaChange", null),
        (0, o.gn)([c.Fl], O.prototype, "minA", null),
        (0, o.gn)([c.Fl], O.prototype, "maxA", null),
        (0, o.gn)([a.ak], O.prototype, "onColorChange", null),
        (0, o.gn)([a.ak], O.prototype, "showModal", null),
        (0, o.gn)([a.ak], O.prototype, "hideModal", null),
        (O = (0, o.gn)([d.Pi], O));
      class x {
        constructor() {
      ...
      (0, o.gn)([c.LO], x.prototype, "runningAppKey", void 0),
        (0, o.gn)([a.ak], x.prototype, "onSceneApplicationStateChanged", null);
      class F extends r.Component {
        constructor(e) {
          D || (D = new x()), super(e), (this.state = { currentApp: null });
        }
        componentDidMount() {
      ...
      (0, o.gn)([a.ak], F.prototype, "onSceneApplicationStateChanged", null),
        (0, o.gn)([a.ak], F.prototype, "onControllerDropdownChanged", null);
      const H = (e) => {
    ...
    7176: (e, t, n) => {
      ...
      const i = "openvr.tool.steamvr_environments",
        ...
        X = "/settings/steamvr/backgroundCameraHeight",
    ...
    5211: (e, t, n) => {
      ...
      class E {
        constructor(e, t, n, i, s) {
          (this.m_BindingUISource = void 0),
            ...
            (this.m_sInputPath = i),
            (this.m_sActionSet = s),
            (this.m_BindingStoreObserverDisposer = (0, d.N7)(B, (e) => {
              "m_LoadedBinding" == e.name && this.UpdateBindingSource();
            })),
            this.UpdateBindingSource(),
            B.RegisterBindingWatcher(this.UpdateBindingSource.bind(this));
        }
        cancelWatcher() {
          this.m_BindingStoreObserverDisposer(),
            B.UnregisterBindingWatcher(this.UpdateBindingSource);
        }
        UpdateBindingSource() {
          this.m_BindingUISource = B.GetActionBinding(
        ...
        GetActionForInputType(e, t) {
          if (
            ...
            let n = this.m_BindingUISource[e].inputs.get(t).output,
              i = B.GetActionByName(n);
            if (!i) {
              let e = B.GetSimulatedActionByPath(n);
              e && (i = B.CreateActionDefinitionForSimulatedAction(e));
            }
            let s = B.GetAliasInfo(n);
            return (
              i &&
                s &&
                s.alias_name &&
        ...
        SetInputMode(e, t) {
          !this.m_BindingUISource || t < 0 || t >= this.m_BindingUISource.length
            ...
            : (this.ClearNewModeIfSet(t),
              B.SetInputModeForInputSource(this.GetFullInputPath, t, e));
        }
        AddInputMode(e) {
          this.m_iNewSourceEntry = B.AddInputModeForSource(
            this.GetFullInputPath,
            e
          );
        }
        DeleteInputMode(e) {
          !this.m_BindingUISource || e < 0 || e >= this.m_BindingUISource.length
            ? console.error("SetInputMode: Invalid mode index for new mode")
            : B.DeleteInputModeForSource(this.GetFullInputPath, e);
        }
        ClearNewModeIfSet(e) {
        ...
        SetClickAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "click", t, [
            "button",
            "trackpad",
            "joystick",
            "trigger",
        ...
        SetTouchAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "touch", t, [
            "button",
            "trackpad",
            "joystick",
            "trigger",
        ...
        SetHeldAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "held", t, [
            "button",
            "complex_button",
          ]);
        }
        SetLongAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "long", t, [
            "button",
            "complex_button",
          ]);
        }
        SetSingleAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "single", t, [
            "button",
            "complex_button",
          ]);
        }
        SetDoubleAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "double", t, [
            "button",
            "complex_button",
          ]);
        }
        SetPositionAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "position", t, [
            "trackpad",
            "joystick",
          ]);
        }
        SetNorthAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "north", t, [
            "dpad",
            "dpad_click",
            "dpad_touch",
          ]);
        ...
        SetEastAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "east", t, [
            "dpad",
            "dpad_click",
            "dpad_touch",
          ]);
        ...
        SetSouthAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "south", t, [
            "dpad",
            "dpad_click",
            "dpad_touch",
          ]);
        ...
        SetWestAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "west", t, [
            "dpad",
            "dpad_click",
            "dpad_touch",
          ]);
        ...
        SetCenterAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "center", t, [
            "dpad",
            "dpad_click",
            "dpad_touch",
          ]);
        ...
        SetScrollAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "scroll", t, [
            "scroll",
          ]);
        }
        SetPullAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "pull", t, [
            "trigger",
          ]);
        }
        SetForceAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "force", t, [
            "force_sensor",
          ]);
        }
        SetGrabAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "grab", t, [
            "grab",
          ]);
        }
        SetValueAction(e, t) {
          B.SetActionForInputModeType(this.GetFullInputPath, e, "value", t, [
            "scalar_constant",
          ]);
        }
        CopyActions(e) {
          B.ClearModesForInputPath(this.GetFullInputPath),
            e.GetModes.forEach((e, t) => {
              B.AddInputModeForSource(this.GetFullInputPath, e.mode),
                e.inputs.forEach((e, n) => {
                  B.SetActionForInputModeType(
                    this.GetFullInputPath,
                    t,
                    n,
                    e.output,
        ...
        SetClickParameter(e, t, n) {
          B.SetParameterForInputModeType(
            this.GetFullInputPath,
            e,
            "click",
            t,
        ...
        SetParameter(e, t, n, i) {
          B.SetParameterForInputModeType(this.GetFullInputPath, e, t, n, i);
        }
        GetClickParameter(e, t) {
          return B.GetParameterForInputModeType(
            this.GetFullInputPath,
            e,
            "click",
            t
        ...
        GetParameter(e, t, n) {
          return B.GetParameterForInputModeType(this.GetFullInputPath, e, t, n);
        }
        GetTrackpadInvertState(e) {
          switch (
            B.GetParameterForInputModeType(
              this.GetFullInputPath,
              e,
              "trackpad",
              "invert"
      ...
      (0, r.gn)([a.ak], L.prototype, "resolve", null),
        (0, r.gn)([a.ak], L.prototype, "reject", null),
        (function (e) {
      ...
      class T {
        ...
        GetDefaultBindingNameForSaveType(e) {
          let t = B.SelectedControllerTypeInfo,
        ...
        OnWorkshopUploadComplete(e) {
          if (
            ...
            e.app_key != B.SelectedApp)
          )
            return void console.log(
              `Ignoring binding load for an app we aren't viewing. Pending: ${e.app_key}. Current: ${B.SelectedApp}.`
            );
        ...
        OnPendingFileSaved(e) {
          ...
          console.log(`OnPendingFileSaved: ${t}. ${e}`),
            e.app_key == B.SelectedApp ||
              console.log(
                `Ignoring pending file saved for an app we aren't viewing. Pending: ${e.app_key}. Current: ${B.SelectedApp}.`
              );
        }
        get SaveNoticeText() {
          if (this.m_OutstandingSaveBindingCalls.length > 0) {
        ...
        OnBindingConfigLoaded(e) {
          ...
          if (
            ...
            let e = B.SelectedControllerTypeInfo,
        ...
        OnActionManifestReloaded(e) {
          e.app_key == B.SelectedApp && this.ReloadCurrentApp();
        }
        SetBindingURL(e) {
      ...
      const B = new T();
      window.controllerBindingStore = B;
    },
    8155: (e, t, n) => {
      "use strict";
      n.d(t, { GZ: () => l, vs: () => c });
...
//# sourceMappingURL=vrwebui_shared.js.map?v=eb41021e549a3ce4b523
