        ...
        componentDidMount() {
          (this.m_routeObservingAutorunDisposer = (0, a.EH)(() => {
            S.G3.routePage
              ...
              : S.G3.setRoutePage(
                  S.G3.settingsSchema.filter(Ce.shouldShowSection)[0].controller
                );
          })),
          ...
          return s.createElement(
            ...
            this.state.bShowingModal &&
              s.createElement(
                ...
                e &&
                  s.createElement("h1", null, "No controller dongles detected.")
              )
          );
        }
      };
      ...
      const X = (e) => {
          ...
          return (
            ...
            r.createElement(
              ...
              s && r.createElement("div", { className: "Subsection Bottom" }, s)
            )
          );
        },
        j = (e) => {
      ...
      class d {
        ...
        HandleTimeout(e) {
          ...
          this.DeletePendingRequest(e),
            null == t ||
              t.fnReject(
                new l({ error: i.Cj.k_CVRGamepadUI_Message_ErrorCode_TimedOut })
              );
        }
